...
- [x] **Step 1: 切断 `_item_from_suggestion` 的回本调用**
...
- [x] **Step 2: 禁用 `_build_payback` 函数体并加 DEPRECATED 注释**
...
- [x] **Step 3: `build_life_trajectory` docstring 中性化**
...
- [x] **Step 1: `life_trajectory.py` 模块 docstring 加 DEPRECATED 标注**
...
- [x] **Step 2: `PaybackAnalysis` docstring 加 DEPRECATED 标注**
...
- [x] **Step 3: `LifeTrajectory` 顶层 docstring 中性化**
...
- [x] **Step 4: `life_path.py` 模块 docstring 加 DEPRECATED 标注**
...
- [x] **Step 1: 读取确认 life_path.py 主推荐流程是否调用**
...
- [x] **Step 2: 模块顶部 + 关键函数加 DEPRECATED 注释**
...
- [x] **Step 1.5: 为 deprecated 端点添加 FastAPI metadata**
...
- [x] **Step 3: `life_trajectory` handler docstring 中性化 + deprecated 标记**
...
- [x] **Step 4: `life_paths` handler docstring 加 deprecated 标记**
...
- [x] **Step 5: 响应 notes 追加 deprecated 提示**
...
- [x] **Step 4: 中性化 `LifePathsPage.tsx` 遗留页面文案**
...
- [x] **Step 2: 运行测试，预期 PASS（前面任务已清文案）**
...
- [x] **Step 2: 勾选 tasks.md 全部任务**

把 `openspec/changes/deprecate-life-path-narrative/tasks.md` 中所有 `- [x]` 改为 `- [x]`（17 项）。
