...
- [ ] **Step 1: 创建引擎文件 + affordability 分类器**
...
- [ ] **Step 2: market×fit 门控测试（需构造最小 build_advisory 调用）**
...
把 `openspec/changes/volunteer-advisory-engine/tasks.md` 中所有 `- [ ]` 改为 `- [x]`。
